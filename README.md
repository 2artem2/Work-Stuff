...
| № | Название | Приоритет | Описание | Сложность | Соотносится с системами безопасности | 
| :--- | :---        | :---   | :--- | :---    | :---     
| 2.1 | Управление исходным кодом | 1 | Используйте централизованную систему управления исходным кодом (SCM), например Bitbucket, GitHub или Gitlab. | <span style="color: green">Легкий</span> | <ul><li>APRA234</li><li>CIS8</li><li>ISM GSD</li><li>ISO27001</li><li>NIST 800-53B</li><li>SSDF1.1</li></ul> | 
